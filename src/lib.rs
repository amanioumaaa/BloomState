...
#[derive(Debug)]
pub struct BloomStateProcessor {
    verbose: bool,
    processed_count: usize,
}

impl BloomStateProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BloomState processing");
    
    let mut processor = BloomStateProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BloomStateProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BloomStateProcessor::new(false);
